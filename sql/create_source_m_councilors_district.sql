drop table if exists poliquant.source.m_councilors_district
;

create table if not exists poliquant.source.m_councilors_district
(
  id INT64 options(description="The code of '小選挙区' in type column follows the rule of JIS X 0401. In addition, the number 99 means '比例' in type column."),
